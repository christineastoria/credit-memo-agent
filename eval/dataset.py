...
EXAMPLES = [
    {
        ...
        "outputs": {
            ...
            "pe_diligence_criteria": [
                "Discusses ownership structure or sponsor involvement",
                "Includes downside or stress scenario with impact on leverage and coverage",
                "Discusses management team quality or tenure",
                "Addresses covenant structure or debt terms",
                "Discusses maturity profile or refinancing considerations",
                "Compares against similar deals in the sector using data from the deal database",
                "Identifies sector-specific or borrower-specific risk factors",
            ],
        },
    },
    {
        ...
        "outputs": {
            ...
            "pe_diligence_criteria": [
                "Discusses PE sponsor involvement and equity contribution",
                "Includes downside or stress scenario with impact on leverage and coverage",
                "Discusses physician recruitment, retention, or key-person considerations",
                "Addresses covenant structure or debt terms",
                "Discusses maturity profile or refinancing considerations",
                "Compares against similar healthcare deals using data from the deal database",
                "Identifies healthcare-specific risks (reimbursement, payor mix, regulatory)",
            ],
        },
    },
    {
        ...
        "outputs": {
            ...
            "pe_diligence_criteria": [
                "Discusses ownership structure or acquisition history",
                "Includes downside or stress scenario with impact on leverage and coverage",
                "Discusses management team or key-person risk (e.g. CTO transition)",
                "Addresses covenant structure or debt terms",
                "Discusses maturity profile or refinancing considerations",
                "Compares against similar technology deals using data from the deal database",
                "Identifies technology-specific risks (integration, customer concentration, churn)",
            ],
        },
    },
]
